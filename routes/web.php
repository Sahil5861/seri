...
Route::get('seriadmissions', [HomeController::class, 'AdmissoinBrand'])->name('admission-brand');



Route::get('reach-us', function (){
    return view('frontend.reach');
})->name('reach-us');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/update-passoword', [ProfileController::class, 'update_password'])->name('update-passoword');
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::prefix('blog_category')->name('blogs.category.')->group(function () {
