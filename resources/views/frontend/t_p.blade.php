...
<div data-elementor-type="wp-post" data-elementor-id="436" class="elementor elementor-436 elementor-304">
    {{-- here it is --}}      
    <div class="banner" style="background: url('../images/people-taking-part-high-protocol-event.jpg') no-repeat center center / cover;">
    </div>
    <script>
        // Counter Animation
    ...
    <section class="container-lg p-4">
        ...
        <div class="row d-flex flex-column-reverse flex-lg-row">
            <div class="col-lg-12 main" style="font-family:Arial, Helvetica, sans-serif;">
                ...
                <div class="content">
                    <h4>Our Placement-Centric Methodology</h4>
                    <p>Our unique methodology ensures you’re not just ready but ahead in the job market:</p>

                    <li>Industry-Synced Training (IST): Our hands-on approach, through Centers of Excellence and live projects, prepares learners for real-world challenges. </li>
                    <li>Strategic Placement Preparation (SPP): From day one, we integrate placement training with academics. Tailored workshops, resume building, and interview prep sessions, guided by experts, equip you for top-tier job opportunities.</li>
                    <li>Robust Industry Links (RIL): Leverage our strong connections with over leading national and international MNCs for internships and in-plant training, giving learners a competitive edge in the job market.</li>
                ...
                <div class="content">
                    ...
                    <ul>
                        <li style="list-style: disc;"><strong>Empowerment:</strong> To empower students by providing them with the knowledge, skills, and opportunities necessary for career success. </li>
                        <li style="list-style: disc;"><strong>Guidance:</strong> To guide students through their academic and professional journeys, offering advice and support tailored to their individual needs. </li>
                        <li style="list-style: disc;"><strong>Opportunity Creation:</strong> To connect students with a wide range of career opportunities, facilitating their entry into the professional world.</li>                        
                    </ul>
                </div>
            </div>            
        </div>
