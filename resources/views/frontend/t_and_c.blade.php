    ...
    <section class="container-lg p-4">
        ...
        <div class="row d-flex flex-column-reverse flex-lg-row">
            <div class="col-lg-12 main" style="font-family:Arial, Helvetica, sans-serif;">                
                <div class="content"> 
                    <h2>{{env('COLLEGE_NAME')}} B.Tech: Fee Structure & Admission Payments</h2>
                    <p>Welcome to the official Terms and Conditions governing the use of services provided by {{env('COLLEGE_NAME')}} . These terms outline the rights and obligations between the institute and its students, applicants, and website users, with a primary focus on the fee payment structure for B.Tech programs. By accessing our website https://seri.net.in/, applying for admission, or utilizing any of our services, you agree to be bound by these Terms and Conditions.</p>
                </div>
                ...
                <div class="content" id="btech_program_fee_structure">
                    ...
                    <p>The general annual fee for B.Tech programs at {{env('COLLEGE_NAME')}} is <strong>INR 1.25 Lakhs per annum<sup>*</sup></strong>.</p>
                ...
                <div class="content" id="admission_fee_payment_process">
                    ...
                    <p>The process for fee payment for B.Tech admissions at {{env('COLLEGE_NAME')}} is detailed as follows:</p>

                    <ul>
                        <li><strong>Initial Counselling Allotment Fees (Category-I):</strong>Candidates who are allotted a seat at {{env('COLLEGE_NAME')}} through official counselling bodies are required to pay an initial fee directly to the counselling authority. This payment secures the provisional allotment</li>
                        <li>
                            <strong>●	Balance Fee Payment (Category-I & II):</strong>
                            <ul>
                                <li>For Category-I candidates, the remaining balance of the annual fee (after deducting the amount paid to the counselling body) must be paid directly to {{env('COLLEGE_NAME')}} during the mandatory physical reporting at the campus.</li>
                ...
                <div class="content" id="refund_policy_for_btech_admissions">
                    ...
                    <p>{{env('COLLEGE_NAME')}} maintains its refund policies in accordance with applicable regulatory guidelines and institutional discretion.</p>

                    <ul>
                        <li><strong>General Refund Guidelines:</strong> Any refund requests for B.Tech admissions will be processed strictly in accordance with the prevailing norms and timelines set by regulatory bodies such as AICTE, and the specific policies of {{env('COLLEGE_NAME')}}.</li>
                ...
                <div class="content" id="eligibility_and_admission_process">
                    ...
                    <p>Admission to B.Tech programs at {{env('COLLEGE_NAME')}} is primarily based on candidates' performance in national/state-level entrance examinations and academic qualifications.</p>
                    <ul>
                        ...
                        <li><strong>Post-Allotment Process:</strong> Upon provisional allotment of a seat (either through counselling or management quota), candidates are required to complete a mandatory physical reporting process at the {{env('COLLEGE_NAME')}} campus. This includes verification of original documents and payment of the balance fees as outlined in Section 3. Failure to comply with these steps within the specified schedule will lead to the cancellation of admission without any extension.</li>
                    </ul>
                </div>
                ...
                <div class="content" id="general_legal_provisions">
                    ...
                    <ul>
                        <li><strong>Intellectual Property Rights:</strong> All content on the Platform, including text, graphics, logos, images, and software, is the proprietary property of {{env('COLLEGE_NAME')}} or its content suppliers and is protected by applicable intellectual property laws.</li>
                        <li><strong>Disclaimer of Warranties:</strong> The Platform and its services are provided on an "as is" and "as available" basis. {{env('COLLEGE_NAME')}} makes no warranties, express or implied, regarding the operation of the Platform or the accuracy of information, except for the terms explicitly stated herein regarding fees and admissions.</li>
                        <li><strong>Limitation of Liability:</strong> {{env('COLLEGE_NAME')}} shall not be liable for any direct, indirect, incidental, punitive, special, or consequential damages arising from the use of, or inability to use, the Platform or its services, or any financial losses incurred due to non-adherence to fee payment schedules or refund policies.</li>
                        <li><strong>Indemnification:</strong> You agree to indemnify and hold {{env('COLLEGE_NAME')}}, its affiliates, officers, directors, employees, and agents harmless from any claims, demands, losses, liabilities, costs, and expenses (including legal fees) arising from your use of the Platform or your breach of these Terms.</li>
                        ...
                        <li><strong>Amendments to Terms:</strong> {{env('COLLEGE_NAME')}} reserves the right to modify these Terms and Conditions, especially those pertaining to fee structures and refund policies, at any time. Any changes will be posted on this page, and your continued use of the Platform or services after such modifications will constitute your acceptance of the updated terms.</li>
                    </ul>
                </div>
                ...
                <div class="content" id="contact_information">
                    ...
                    <strong>({{env('COLLEGE_NAME')}})</strong>
                    <ul>
