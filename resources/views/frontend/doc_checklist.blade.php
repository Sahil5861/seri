        ...
        <div class="row d-flex flex-column-reverse flex-lg-row">
            <div class="col-lg-12 main" style="font-family:Arial, Helvetica, sans-serif;">
                ...
                <div class="content"> 
                    ...
                    <li>JEE main score card (final).</li>
                    ...
                    <li>category certificate (issued After 01 April 2025)</li>
                    <li>(EWE/OBC/ SC/ST)</li>
                    <li>Sub category certificate ( UPHC/ UPAF/ UPFF)</li>
                    <li>Income certificate (issued After 01 April 2025)</li>
                    <li>Anti Ragging Certificate / Affidavit.</li>
                    <li>ORIGINAL 3 set of photocopy (UPLOADED AT JEE MAIN FORM )</li>
                </div>
