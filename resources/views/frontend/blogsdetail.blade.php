        ...
        <div class="row my-1">
            <div class="col-lg-12">
                <div class="container">
                    ...
                    <h1 class="blog-title" style="line-height:1.6; font-weight:600;margin:20px 0; font-family:poppins;">
                        {{$blog->blog_title}}
                    ...
                    <div class="social-icons">
                        <ul>
                            <li><a href="https://www.facebook.com/profile.php?id=61574962801635"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="https://www.instagram.com/seri.grnoida?igsh=Zm91cjZha25keGl2"><i class="fa fa-instagram"></i></a></li>
                            <li><a href="https://x.com/seri_grnoida?t=NEiDJxcgkY-r5yF7bAz6aQ&s=08"><i class="fa-brands fa-x-twitter"></i></a></li>
