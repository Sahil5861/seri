...
<style>
    ...
    .author_image {
        background: url("{{ asset($blog->author_image) }}");
        ...
        <div class="e-con-inner">
            <div class="elementor-element elementor-element-e33acf4 e-con-full e-flex e-con e-child blogs_feild" data-id="e33acf4" data-element_type="container">
                <div class="elementor-element elementor-element-c059924 elementor-invisible elementor-widget elementor-widget-image"
                    ...
                    <div class="container mt-4" style="text-align: left; line-height:1;">
                        <h1 class="text-primary" style="font-weight: bold; line-height:1.2;">{{$blog->blog_title}}</h1> 
                        <section class="blog-categories" style="margin:10px 0;">
                            <span style="display: inline-block; background: #007bff; color: white; padding: 10px 20px; border-radius: 20px; font-size: 18px; font-weight: bold;">
                                Knowlwdge
                            </span>
                            <span style="display: inline-block; background: #007bff; color: white; padding: 10px 20px; border-radius: 20px; font-size: 18px; font-weight: bold;">
                                University
                        ...
                        <section class="author-section" style="border-top: 1px solid #222; border-bottom:1px solid #222; height:max-content; padding:10px 0; display:flex; justify-content:space-between; align-items:center;">
                            <div class="about-author" style="display:flex; justify-content:flex-start; align-items:center; gap:10px;">
                                <div class="author_image"></div><b style="width: auto;">By : {{$blog->author_name}}</b> | <b style="width: auto;">{{$blog->author_designation}}</b>
                            </div>
                        ...
                        {{-- <div style="display: flex; align-items: center; gap: 10px; width: 100%;">
                            <b style="width: auto;">{{$blog->author_name}}</b> 
