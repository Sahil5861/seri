                        ...
                        <ul style="display: flex;">
                            ...
                            <li style="position:relative" class="dropdown-a" >
                                ...
                                <ul class="elementskit-dropdown elementskit-submenu-panel dropdown" style="width:max-content; flex-direction:column;">
                                    ...
                                    <li class="menu-item nav-item">
                                        <a href="#" class="dropdown-item">Electronics & Communication Engineering</a>
                                    </li>
                                    <li class="menu-item nav-item">
                                        <a href="#" class="dropdown-item">Computer Science & Information Technology</a>
                                    </li>
                                    <li class="menu-item nav-item">
                            ...
                            <li style="position:relative" class="dropdown-a">
                                ...
                                <ul class="elementskit-dropdown elementskit-submenu-panel dropdown" style="width:max-content; flex-direction:column;">
                                    <li class="menu-item nav-item">
                                        <a href="{{route('admissions')}}" class="dropdown-item">Admissions</a>
                                    </li>
                                    <li class="menu-item nav-item">
                                        <a href="{{route('apply_now')}}" class="dropdown-item">Apply Now</a>
                                    </li>
                                    <li class="menu-item nav-item">
                                        <a href="#" class="dropdown-item">Courses Offered</a>
                                    </li>
                                    </li>
                                    <li class="menu-item nav-item">
                                        <a href="#" class="dropdown-item">Eligibility Criteria</a>
                                    </li>
                                    <li class="menu-item nav-item">
                                    ...
                                    <li class="menu-item nav-item">
                                        <a href="#" class="dropdown-item">Online Anti Ragging Affidavit Procedure</a>
                                    </li>
                                    <li class="menu-item nav-item">
                                        <a href="#" class="dropdown-item">College Rules and Regulations</a>
                                    </li>
                                    <li class="menu-item nav-item">
                                        <a href="#" class="dropdown-item">Prospectus</a>
                                    </li>
                                    <li class="menu-item nav-item">
                                        <a href="#" class="dropdown-item">Admissions Policy</a>
                                    </li>
                                </ul>
                            </li>
                            
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-24 nav-item elementskit-mobile-builder-content" data-vertical-menu="750px"><a href="">Academics Infrastructure</a></li>
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-24 nav-item elementskit-mobile-builder-content" data-vertical-menu="750px"><a href="">R&D Cell</a></li>
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-24 nav-item elementskit-mobile-builder-content" data-vertical-menu="750px"><a href="">T&P</a></li>
