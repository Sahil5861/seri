<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
            ...
            <div style="display: flex;width: 100%;">                
                <div style="position: absolute; right: 0;"><ul style="list-style: none; display: flex;">
                 ...
                 {{-- <div class="header-logo">
                    <img src="{{ asset('images/' . env('COLLEGE_IMAGE')) }}" alt="Institute Logo" style="width: 210px;height: auto;">
                 </div> --}}
                <div style="width: 100%;padding:0 0;">
                    <div style="display: flex;justify-content: flex-end;">
                        <!--<div class="header-title">{{env('COLLEGE_NAME_MID')}} ENGINEERING AND RESEARCH INSTITUTE</div>-->
                        <div class="header-title logo" style="margin:auto">
                            ...
                            <img src="{{asset('images/'.env('COLLEGE_IMAGE_LONG'))}}" alt="IMAGE">
                        </div>
                        ...
                        <ul style="display: flex;">
                            ...
                            <li style="position:relative" class="dropdown-a">
                                ...
                                <ul class="elementskit-dropdown elementskit-submenu-panel dropdown" style="width:max-content; flex-direction:column;">
                                    ...
                                    {{-- <li class="menu-item nav-item">
                                        <a href="#" class="dropdown-item">Fee Structures</a>
                                    </li> --}}
                                    <li class="menu-item nav-item">
                                        <a href="{{route('doc-checklist')}}" class="dropdown-item">Document Checklist</a>
                                    </li>
                                    <li class="menu-item nav-item">
                                        <a href="{{route('anti-ragging')}}" class="dropdown-item">Online Anti Ragging Affidavit Procedure</a>
                                    </li>
                                    <li class="menu-item nav-item">
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-24 nav-item elementskit-mobile-builder-content" data-vertical-menu="750px"><a href="{{route('view-tp')}}">T&P</a></li>
                            ...
                            <li style="float: right;"><a href="{{route('home')}}">Careers</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <div class="header-2">
        <div class="header-title logo-2">
            ...
            <img src="{{asset('images/'.env('COLLEGE_IMAGE_LONG'))}}" alt="IMAGE" width="380px">
        </div>
            ...
            <ul style="display: flex;">
                ...
                <li style="position:relative" class="dropdown-a" >
                    ...
                    <ul class="elementskit-dropdown elementskit-submenu-panel dropdown" style="width:max-content; flex-direction:column; align-items:flex-start;">                                                                    
                        ...
                        <li class="menu-item nav-item"><a class="dropdown-item" href="{{route('view-tp')}}">T&P</a></li>     
             ...
             <div class="header-logo">
                <img src="{{ asset('images/' . env('COLLEGE_IMAGE')) }}" alt="Institute Logo" style="width: 90px;height: auto;">
                 <div class="header-title logo">
                    ...
                    <p class="sub" style="font-family: 'Times New Roman', serif !important;">{{env('COLLEGE_NAME')}}</p>
                </div>
            </div>
    ...
    <div id="mobile-menus" class="mobile-menu flex flex-col bg-[#a51c30] p-4 space-y-2 transition-all fixed h-[95vh] z-[9999] w-[300px] right-0 pt-10 lg:hidden" style="background-color: var(--e-global-color-accent);">
        <ul>
            <li><a href="{{ route('home') }}" class="{{request()->routeIs('home') ? 'active' : ''}}">Home</a></li>
            <li><a href="{{ route('about') }}" class="{{request()->routeIs('about') ? 'active' : ''}}">About {{env('COLLEGE_NAME_SHORT')}}</a></li>
            {{-- <li style="position:relative"><a href="#" class="ekit-menu-nav-link ekit-menu-dropdown-toggle {{request()->routeIs('courses') ? 'active' : ''}}">B.Tech Programs                
                </a>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="programsDropdown" style="w">
                  <li><a class="dropdown-item text-dark" style="white-space: normal;" href="{{route('view-courses', 'cse')}}">Computer Science and Engineering</a></li>
                  <li><a class="dropdown-item text-dark" style="white-space: normal;" href="{{route('view-courses', 'ec')}}">Electronics & Communication Engineering</a></li>
                  <li><a class="dropdown-item text-dark" style="white-space: normal;" href="{{route('view-courses', 'csit')}}">Computer Science & Information Technology</a></li>
                  <li><a class="dropdown-item text-dark" style="white-space: normal;" href="{{route('view-courses', 'aiml')}}">CSE (Artificial Intelligence & Machine Learning)</a></li>
                </ul>
            </li>
            ...
            {{-- <li  class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="insightsDropdown" style="border-radius: 0;">
                    <li>
                        <a  style="color: #000;" class="dropdown-item" href="{{route('academics')}}">Academics Infrastructure</a>
                    </li>
                    <li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" style="width:max-content; flex-direction:column; align-items:flex-start; overflow-y:auto; height:380px;">
                    ...
                    <li class="menu-item nav-item"><a href="{{route('apply_now')}}" class="dropdown-item text-dark" style=" white-space: normal;">Apply Now</a></li>
                    <li class="menu-item nav-item"><a href="{{route('coursesoffered')}}" class="dropdown-item text-dark" style=" white-space: normal;">Courses Offered</a></li>
                    <li class="menu-item nav-item"><a href="{{route('eligibility')}}" class="dropdown-item text-dark" style=" white-space: normal;">Eligibility Criteria</a></li>                                    
                    <li class="menu-item nav-item"><a href="{{route('doc-checklist')}}" class="dropdown-item text-dark" style=" white-space: normal;">Document Checklist</a></li>
                    <li class="menu-item nav-item"><a href="{{route('anti-ragging')}}" class="dropdown-item text-dark" style=" white-space: normal;">Anti-Ragging Policy</a></li>
                    <li class="menu-item nav-item"><a href="{{route('view-rules')}}" class="dropdown-item text-dark" style=" white-space: normal;">College Rules and Regulations</a></li>                                    
                    <li class="menu-item nav-item"><a href="{{route('admission-policy')}}" class="dropdown-item text-dark" style=" white-space: normal;">Admission Policy</a></li>
