<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
            ...
            <div style="display: flex;width: 100%;">                
                ...
                <div style="width: 100%;padding:0 0;">
                    <div style="display: flex;justify-content: flex-end;">                        
                        <div class="header-title logo" style="margin:auto; margin-right:280px;margin-left:30px;">
                            ...
                            <span style="font-weight:600;margin:0 20px; font-size:30px;">SITASRM ENGINEERING & RESEARCH INSTITUTE</span>                            
                        </div>
    ...
    <div class="header-2">
        <div class="header-title logo-2">
            ...
            {{-- <span class="main">{{env('COLLEGE_NAME_SHORT')}}</span> --}}
            <span style="margin:0 20px; font-weight:600; width:100%; font-size:24px;">SITASRM ENGINEERING <br> & RESEARCH INSTITUTE</span>                            
        </div>
        ...
        <div style="display:flex;align-items: center; justify-content: space-between;">
             <div class="header-logo">
                <img src="{{ asset('images/' . env('COLLEGE_IMAGE')) }}" alt="Institute Logo" style="width: 90px;height: auto;">
                 <div class="header-title logo" style="display: flex; flex-direction:column;justify-content:center;">
