...
<style>
    ...
    .banner {
            height: 100vh;
            background: url('../images/contact_banner.png') no-repeat center center / cover;
            position: relative;
            overflow: hidden;
    }
...
<div data-elementor-type="wp-post" data-elementor-id="436" class="elementor elementor-436" style="background-color: #fff; !important">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="info-box h-100">
                            ...
                            <p><i class="fas fa-map-marker-alt me-2"></i>{{env('COLLEGE_NAME_MID')}} ENGINEERING & RESEARCH INSTITUTE 
                                Plot No. 14, Knowledge Park III, Greater Noida, Uttar Pradesh 201310
                                </p>
                            <p><i class="fas fa-envelope me-2"></i>Email: 
                                <a href="#" class="text-white">info@seri.in</a>
                            </p>
                            <p><i class="fas fa-phone me-2"></i>Call: +91-9560-339-929 +91-9560-990-539
                                </p>
                        </div>
                    </div>
                    ...
                    {{-- <div class="col-md-6 mb-3">
                        <div class="info-box h-100">
                            ...
                            <p><i class="fas fa-map-marker-alt me-2"></i>SITASRM ENGINEERING & RESEARCH INSTITUTE 
                                Plot No. 14, Knowledge Park III, Greater Noida, Uttar Pradesh 201310
                                </p>
                            <p><i class="fas fa-envelope me-2"></i>Email: 
                                <a href="mailto:support@dypatiledu.com" class="text-white">info@seri.com</a>
                            </p>
                            <p><i class="fas fa-phone me-2"></i>Call: +91 2264134600</p>
                        </div>
                    </div> --}}
                </div>
            </div>        
