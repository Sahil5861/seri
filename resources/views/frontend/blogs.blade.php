...
.card-text {
    ...
    @media screen and (max-width:400px){
        ...
        .banner {
            ...
            position: relative;
            overflow: hidden;   
            background: url('../images/blog_banner.jpg') no-repeat center center / cover;         
            display: flex;
        ...
        .banner{
            background: url('../images/blog_banner.jpg') no-repeat left top / cover;     
        }
...
<div data-elementor-type="wp-post" data-elementor-id="1184" class="elementor elementor-1184">
    <section class="banner">
        <div class="banner-content">
            <h1 style="">Step into your engineering future with SERI's B.Tech blog</h1>
            <p>Learn about industry-relevant programs (CSE, ECE, ME, CE), practical skills, projects, and career pathways for tech leaders.</p>
        </div>
    </section>
